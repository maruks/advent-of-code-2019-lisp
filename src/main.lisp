...
(defun run ()
  ...
  (println "---------------------- day 5 ----------------------")
  (println (day-5:solution-1))
  (println (day-5:solution-2))
  (println "---------------------- day 6 ----------------------")
  (println (day-6:solution-1))
  (println (day-6:solution-2))
  (println "---------------------- day 7 ----------------------")
  (println (day-7:solution-1))
  (println (day-7:solution-2))
  (println "---------------------- day 8 ----------------------")
  (println (day-8:solution-1))
  (println (day-8:solution-2))
  (println "---------------------- day 9 ----------------------")
  (println (day-9:solution-1))
  (println (day-9:solution-2))
  (println "---------------------- day 10 ----------------------")
